...
class TimeSeriesDataset(Dataset):
    def __init__(self,data_csv_path, history_size=600, forecast_size=1, interval=96):
    ...
    def get_single_item(self, idx):
        ...
        return torch.Tensor(x_data), torch.Tensor(y_data)[..., 5:6]#choose predict label column
